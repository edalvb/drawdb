...
const en = {
  translation: {
    ...
    group_tables_desc:
      "Automatically organize tables into groups using foreign keys and the semantic similarity of their names, then wrap each group in a subject area.",
    number_of_groups: "Number of groups",
    use_semantic_grouping: "Use semantic similarity",
    semantic_model_note:
      "Runs a small AI model in your browser. Downloads ~25 MB the first time, then works offline.",
    grouping_tables: "Grouping tables...",
    computing_embeddings: "Analyzing table names...",
    downloading_model: "Downloading model...",
    grouping_done: "Tables grouped",
    grouping_failed: "Could not group tables",
    not_enough_tables: "Add at least two tables to group them",
    view: "View",
    header: "Menubar",
    sidebar: "Sidebar",
    toolbar: "Toolbar",
    ...
    group_and_adjust: "Group and adjust",
    show_grid: "Show grid",
    ...
    failed_to_save_to_google_drive: "Failed to access Google Drive",
    invalid_file: "Invalid diagram file",
    loaded_diagram: "Loaded diagram",
    drive_not_configured:
      "Google Drive is not set up. Add VITE_GOOGLE_CLIENT_ID and VITE_GOOGLE_API_KEY to .env and restart.",
