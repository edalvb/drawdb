...
const es = {
  translation: {
    ...
    group_tables: "Agrupar tablas",
    group_tables_desc:
      "Organiza automáticamente las tablas en grupos usando las claves foráneas y la similitud semántica de sus nombres, y envuelve cada grupo en un área temática.",
    number_of_groups: "Número de grupos",
    use_semantic_grouping: "Usar similitud semántica",
    semantic_model_note:
      "Ejecuta un modelo de IA pequeño en tu navegador. Descarga ~25 MB la primera vez y luego funciona sin conexión.",
    grouping_tables: "Agrupando tablas...",
    computing_embeddings: "Analizando nombres de tablas...",
    downloading_model: "Descargando modelo...",
    grouping_done: "Tablas agrupadas",
    grouping_failed: "No se pudieron agrupar las tablas",
    not_enough_tables: "Añade al menos dos tablas para agruparlas",
    view: "Ver",
    header: "Encabezado",
    ...
    group_and_adjust: "Agrupar y ajustar",
